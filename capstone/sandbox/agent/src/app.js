...
// Spawn a pty process for the shell
 ...
 * @description Updates the content of files specified in the request body. The request body should contain a property 'updates' with a JSON Array of object,
 * each object should have a 'file' property specifying the file path (relative to the working directory)
 * and a 'content' property specifying the new content of the file.
 * 
 */
 ...
 * @description Creates new files with the content specified in the request body. The request body should contain a property 'files'
 ...
 *  and a 'content' property specifying the content for the new file.
 */
